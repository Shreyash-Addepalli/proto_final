...
function Map0() {
  ...
  const [lng, setLng] = useState(-75.1547403);
  const [lat, setLat] = useState(39.9542255);
      ...
      if (navigator.geolocation) {
        navigator.geolocation.watchPosition(function (position) {
          ...
          if (
            ...
            new MapboxCircle({ lat: 39.9542255, lng: -75.1547403 }, 2000, {
              editable: false,
            ...
            new MapboxCircle({ lat: 39.9542255, lng: -75.1547403 }, 2000 / 15, {
              editable: false,
              fillColor: "#EF0066",
              fillOpacity: 0.75,
            }).addTo(map.current);
