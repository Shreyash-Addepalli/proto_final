          ...
          <div className="menu-content-container">
            <div className="clearfix">
              <div className="image">
                <img
                  className="img2"
                  src="https://nftstorage.link/ipfs/bafybeieyygnsn6avdojrpzauvlu3huwcdhp73s4w75p4vjrb5xm5gjacvy/3.png"
                  alt="Pineapple"
                />
              </div>
              <div className="text">
                <section className="name-1">NFT Artwork</section>
                <section className="name-2">{props.loc}</section>
                <section className="name-3">28.6122,77.2116</section>
              </div>
            </div>
